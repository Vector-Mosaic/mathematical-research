...
const TOOL_ID = 'mathematical_research.run_node_tests'
const ENTRYPOINT = 'node scripts/run-node-tests.mjs'
const USAGE_PAYLOAD = {
  schema_version: 'tool_usage.v1',
  tool_id: TOOL_ID,
  purpose: 'Run compiled Mathematical Research Node test files with node --test.',
